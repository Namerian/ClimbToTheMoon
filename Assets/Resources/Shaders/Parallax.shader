...
Shader "Shader Forge/Parallax" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma target 3.0
            uniform float _offsetdifference;
...
////// Emissive:
                ...
                float node_2630 = (_offsetdifference+_offsetdifference);
                float2 node_8460 = (i.uv0-(node_5752*(node_2630+_offsetdifference)));
                ...
                float2 node_983 = (i.uv0-(node_5752*_offsetdifference));
